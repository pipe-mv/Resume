...
const Modal = ({ project, closeModal }) => {
  ...
  const workedConcepts = concepts.map((concept, index) => {
    return (
      <small className="concepts" key={index}>
        {concept}
      </small>
    );
  });
  ...
  return (
    <article className={`modal ${id && "is-open"}`} onClick={closeModal}>
      <div className="modal-container" onClick={handleModalContainerClick}>
        <a href="#close" className="modal-close" onClick={closeModal}>
          <svg
        ...
        <article className="portfolio-modal">
          ...
          <div className="portfolio-info">
            ...
            <small className="portfolio-details">
              <b></b>
            ...
            <aside className="portfolio-details">
              ...
              <small>
                <a href={link_repository} target="_blank" rel="noreferrer">
                  Visit Repository
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
