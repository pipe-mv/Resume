    ...
    <div>
      <section id="contact" className="contact section">
        <div className="container">
          ...
          <article className="contact-cards d-flex justify-content-center">
            ...
            {/* <aside className="contact-card box-shadow-1">
              ...
              <h5>PHONE</h5>
              <small>
                <a href="tel:0412058336">(+61) 412 058 336</a>
              </small>
            </aside> */}
            <aside className="contact-card box-shadow-1">
              <svg
              ...
              <h5>EMAIL</h5>
              <small>
                <a href="mailto:pipemarin1a@gmail.com">pipemarin1@gmail.com</a>
              </small>
            </aside>
            <aside className="contact-card box-shadow-1">
              <svg
              ...
              <small className="social-media">
                ...
                <a
                  href="https://www.linkedin.com/in/felipe-marin-v"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
